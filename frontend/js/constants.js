const contractAddress = "0xf53e4fBDf61E1d2eD6e85dB53983E716282c82ea"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Antique Porsche Club NFT Project!!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Antique Porsche Club NFT Project is a decentralized, open-source project that would like to share with all Porsche Fans!';
